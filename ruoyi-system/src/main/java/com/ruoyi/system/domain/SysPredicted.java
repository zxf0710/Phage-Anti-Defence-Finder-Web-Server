...
/**
 * 【请填写功能名称】对象 sys_predicted
 * 
 * @author ruoyi
 * @date 2023-04-17
 */
public class SysPredicted extends BaseEntity
{
    ...
    public void setPredictedId(Long predictedId) 
    {
        this.predictedId = predictedId;
    }

    public Long getPredictedId() 
    {
        return predictedId;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            .append("predictedId", getPredictedId())
