...
/**
 * 【请填写功能名称】对象 sys_pdetail
 *
 * @author ruoyi
 * @date 2023-04-17
 */
public class SysPdetail extends BaseEntity
{
    private static final long serialVersionUID = 1L;

    /** 待预测详情id */
    private Long predictedDetailId;
    ...
    /** HMM */
    @Excel(name = "HMM")
    private String hmmEValue;

    /** HMM */
    @Excel(name = "HMM")
    private String hmmScore;
    ...
    public void setPredictedDetailId(Long predictedDetailId)
    {
        this.predictedDetailId = predictedDetailId;
    }

    public Long getPredictedDetailId()
    {
        return predictedDetailId;
    }
    ...
    public void setHmmEValue(String hmmEValue)
    {
        this.hmmEValue = hmmEValue;
    }

    public String getHmmEValue()
    {
        return hmmEValue;
    }
    public void setHmmScore(String hmmScore)
    {
        this.hmmScore = hmmScore;
    }

    public String getHmmScore()
    {
        return hmmScore;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            .append("predictedDetailId", getPredictedDetailId())
            ...
            .append("hmmEValue", getHmmEValue())
            .append("hmmScore", getHmmScore())
